...
{
    public float riftDistanceHandsMultiplyer;
    /// <summary>
    /// The left eye camera.
    /// </summary>
...
#endif
        leftHandAnchor.localPosition = OVRInput.GetLocalControllerPosition(OVRInput.Controller.LTouch) * riftDistanceHandsMultiplyer;
        rightHandAnchor.localPosition = OVRInput.GetLocalControllerPosition(OVRInput.Controller.RTouch) * riftDistanceHandsMultiplyer;
    }
