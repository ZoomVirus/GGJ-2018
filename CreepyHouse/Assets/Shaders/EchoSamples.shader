		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				for(iterator = 0; iterator < 100; iterator++)
				{
					...
					if(_EmitSamples[iterator].x == 0)
						continue;
					float width = _EmitData[iterator].w; //* _WidthScale;//ignore width scale as it needs to be constant for 
